...
public class Background extends Actor {
	...
	super(name);
	background0 = new Sprite(new Texture(Gdx.files.classpath("backgrounds/cel_farmparanoid.png")));
	background1 = new Sprite(new Texture(Gdx.files.classpath("backgrounds/fons_desertic.png")));
	background2 = new Sprite(new Texture(Gdx.files.classpath("backgrounds/BackgroundPlains.png")));
	background3 = new Sprite(new Texture(Gdx.files.classpath("backgrounds/casa_farmparanoid.png")));
